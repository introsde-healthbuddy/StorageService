 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.localdatabase.introsde/", wsdlLocation = "https://healthbuddy-localdatabase.herokuapp.com/soap/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.localdatabase.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://healthbuddy-localdatabase.herokuapp.com/soap/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.localdatabase.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.localdatabase.introsde/", "PeopleImplPort"), People.class, features);
    }
